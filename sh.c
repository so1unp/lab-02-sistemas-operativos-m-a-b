...
void runcmd(struct cmd *cmd)
{
    ...
    case PIPE:
        ...
        if (pipe(pipefd) < 0)
        { // Devuelvo un error si no se puede abrir el pipe
        ...
        {                                   // hijo
            ...
            close(pipefd[1]);               // Cierra el extremo de escritura después de duplicarlo
        ...
        {                                  // padre
            ...
            close(pipefd[0]);              // Cierra el extremo de lectura después de duplicarlo
